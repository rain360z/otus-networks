...
|  10.64.0.0/25| 10.0.0.0/9 | 1:1:1:11::/64 | 1:1:1::/48 |  10.64.0.0/11 Зарезервирована  SW2  | SW2e0/2 VPC7eth0  |
...
| Питер Пользователи |  |     | |   | |
| 10.128.0.0/24      | 10.128.0.0/10 | ----------   | ----------| Питер  | R17e0/0 SW9e0/3|
| -------------      | 10.128.0.0/10 | ----------   | ----------| Питер  | R17e0/2 SW10e1/0|
| -------------      | 10.128.0.0/10 | ----------   | ----------| Питер  | R16e0/2 SW9e1/0|
| -------------      | 10.128.0.0/10 | ----------   | ----------| Питер  | R16e0/0 SW10e0/3|
| -------------      | 10.128.0.0/10 | ----------   | ----------| Питер  | R16e0/3 R32e0/0|
|||||||
...
|||||||
| R17   | e0/2 | IPv4    | -----------------        | --------------       | R17 to SW10  |
| R17   | e0/2 | IPv6    | 1:1:2:6::17/64           | 1:1:2:6::/64           | R17 to SW10    |
| R17   | e0/2 | IPv6 LL | fe80::17          	    | fe80::/10              | R17 to SW10    |
|||||||
| R17   | e0/2.100 | IPv4    | 10.128.0.1/24             | 10.128.0.1/2      | R17 to SW9   |
| R17   | e0/2.100 | IPv6    | 1:1:2:100::17/64           | 1:1:2:100::/64        | R17 to SW9   |
| R17   | e0/2.100 | IPv6 LL | fe80::17          	    | fe80::/10              | R17 to SW9   |
|||||||
|R16||||||
...
|||||||
| R16   | e0/3 | IPv4    | 10.128.255.161/28        | 10.128.255.160/28        | R16 to R32  |
| R16   | e0/3 | IPv6    | 1:1:2:7::16/64       | 1:1:2:7::/64         | R16 to R32  |
| R16   | e0/3 | IPv6 LL | fe80::16         | fe80::/10                | R16 to R32  |
|||||||
| R16   | e0/0.101 | IPv4    | 10.128.1.1/24        | 10.128.0.0/24        | R16 to SW10  |
| R16   | e0/0.101 | IPv6    | 1:1:2:101::16/64   | 1:1:2:101::/64     | R16 to SW10  |
| R16   | e0/0.101 | IPv6 LL | fe80::16         | fe80::/10                | R16 to SW10 |
|||||||
| R16   | e0/2 | IPv4    | -----------------         | -----------------      | R16 to SW9  |
| R16   | e0/2 | IPv6    | -----------------         | -----------------      | R16 to SW9  |
| R16   | e0/2 | IPv6 LL | fe80::16                  | fe80::/10              | R16 to SW9 |
|||||||
| R32   | e0/0 | IPv4    | 10.128.255.162/28        | 10.128.255.161/28        |R32 to R16  |
| R32   | e0/0 | IPv6    | 1:1:2:7::32/64       | 1:1:2:7::/64         | R16 to R32  |
| R32   | e0/0 | IPv6 LL | fe80::32         | fe80::/10              | R16 to R32  |
|||||||


info:
*1 Не вижу смысла, чтобы тратить линки 
*2 Если у нас есть возможности с Триады получить 2 канала до Пtтербурга, то Мы найдем железку для резервирования 2 каналов ну и придется докупить дополнительные сетевые карты.
