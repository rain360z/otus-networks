...
+ Назначим cisco паролем при подключении к консоли и 
   | Задача | Команда|
   |--------|--------|
...
+ Назначим cisco в качестве пороля для удаленного подключения к vty(virtual teletype) и включим проверку пороля при удаленном подключении.
+ 
