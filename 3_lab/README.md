...
+ Это порты не являющиеся root портами, альтернативными портами и направлены от рута.
...
+ из стоимости BID соседнего(их) коммутатора
+ из приоритета порта
+ из названия порта у вышестояшего коммутатора в дереве
